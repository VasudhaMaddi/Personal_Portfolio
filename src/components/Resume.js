    ...
    >
      ...
      >
        ...
        <p className="text-base text-gray-700 mb-4">
          Over 2 years as a Java Full Stack Developer specializing in scalable web applications and microservices. Proficient in RESTful APIs, secure authentication (OAuth2, JWT), and modern front-end frameworks like React.js and Angular.
        </p>
